...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 1500, createdAt: -11000 }));

const expenseTwo = store.dispatch(addExpense({ description: 'Gas', amount: 00, createdAt: -1000 }));
